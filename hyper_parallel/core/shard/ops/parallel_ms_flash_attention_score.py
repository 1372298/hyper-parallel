...
#
# Off by default: the V4 ``softmaxInLayout`` is not available on every Ascend
# platform, so callers must keep their own statistics-reordering path.
